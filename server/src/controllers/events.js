...
export const all = async (req, res) => {
    try {
        const query = "SELECT event.id, title, location, startEvent, endEvent, createdAt, category_id, label, user_id FROM event JOIN categoryevent ON category_id = categoryevent.id ORDER BY event.createdAt DESC";
